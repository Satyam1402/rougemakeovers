...
const ContactForm = ({ onOpenChange }: { onOpenChange?: React.Dispatch<React.SetStateAction<boolean>> }) => {
    ...
    <Form {...form}>
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="Tell us about your event, preferences, and any special requirements..."
        ...
        <Button
          ...
          className="w-full flex justify-center items-center bg-primary text-white px-6 rounded-md shadow-md hover:shadow-xl hover:bg-[#b8965f] transition-all duration-300 font-semibold text-xl py-6 sm:text-2xl sm:py-8"
        >
          {isSubmitting ? (
            "Sending..."
          ) : (
